...
\setCJKmainfont{SimSun} % Set the main font to SimSun, or any other preferred font
...
\begin{center}
    % \textbf{\Huge \scshape Your Name} % English Name
    \textbf{\Huge \scshape Zhicun Tan} % Chinese Name
\end{center}
