...
\begin{tabular}{@{}l@{}r@{\hspace{3cm}}l@{}}
    \multirow{3}[6]{*}{\textbf{\Huge Zhicun Tan(至存 \ 谈)}} & & \begin{tabular}[t]{@{}l@{}}
        ...
        \textbf{Location:} \textbf{Suzhou, Jiangsu} \\
...
I studied Autonomous Systems at DTU and Chalmers, specializing in software development for race car dynamics and robot navigation. I possess strong analytical, practical, teamwork, and communication skills.
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheadingExtended
      ...
      {GPA: 8.86/12 Core courses: Linear control design, Perception for AS, Advanced autonomous robots}
...
\section{Internship \& Work Experience}
  \resumeSubHeadingListStart
    ...
    {\href{https://www.chalmersformulastudent.se/cfs-2023-car-margareta}{Chalmers Formula Student \faExternalLink}}{Chalmers}
      {Autonomous system software engineer}{2022.09 -- 2023.08}
      \resumeItemListStart 
        \resumeItem{Developed a method for converting GPS coordinates to map coordinates, used to verify SLAM map accuracy.} 
        \resumeItem{Developed a Gazebo plugin for a four-wheel vehicle motion simulation to test SLAM and control algorithms.} 
        \resumeItem{Contributed to developing a tool for launching autonomous systems with test options.} 
        \resumeItem{Assisted the team winning the 2023 FSG Autonomous Cup and securing 7th place at FS East.} 
      \resumeItemListEnd
  %   \resumeSubheading
  ...
  %   \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {MCU developer \& head of the lab}{07.2017 -- 07.2018}
      \resumeItemListStart
