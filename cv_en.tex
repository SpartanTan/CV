...
\section{Education}
  ...
  \resumeSubHeadingListStart
    \resumeSubheadingExtended
      ...
      {Courses: Vehicle Motion Engineering, Modelling and Simulation, Artificial Neural Networks, MPC}
  \resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
\resumeSubheading
{Plusgo}{Suzhou, Jiangsu}
{Planning and Control Engineer}{12.2024 -- 05.2025}
\resumeItemListStart
  \resumeItem{Implement the data preprocessing part of prediction algorithm Simpl in C++, reducing processing time to under 10ms.}
  \resumeItem{Developed a backtracking collision detection feature by using GJK algorithm, accelerated 20\%.}
  \resumeItem{Conducted vehicle dynamics calibration, as well as lidar-camera calibration; Wrote multiple documentation.}
  \resumeItem{Implemented a road query module based on KDTree, one  small step for HD map path planning.}
  \resumeItem{Developed a Python-based pipeline to convert point cloud maps into the topological map, including DWG file parsing, coordinate transformation, and visualization.}
  \resumeItem{Participated in deployment and debugging of the PNC module.}
  \resumeItemListEnd 
...
\section{\href{https://1drv.ms/f/s!Al-YZOpjHxorgslbx6yg1s1e4ZGl1A?e=1DVmBG}{Awards \faExternalLink}}
    \resumeSubHeadingListStart
      ...
      \resumeSubheading
      {2023 Formula Student Germany Driverless Cup overall winner}{08.2023}
      {}{}
      \vspace{-4mm}
