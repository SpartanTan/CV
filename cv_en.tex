...
I studied Autonomous Systems at DTU and Chalmers, specializing in software development for race car dynamics and robot control. I possess strong analytical, practical, teamwork, and communication skills.
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheadingExtended
      ...
      {GPA: 8.86/12; Core courses: Linear control design, Perception for AS}
...
\section{Internship \& Work Experience}
  \resumeSubHeadingListStart
    ...
    {\href{https://www.chalmersformulastudent.se/cfs-2023-car-margareta}{Chalmers Formula Student \faExternalLink}}{Chalmers}
      {Autonomous system software engineer}{09.2022 -- 08.2023}
      \resumeItemListStart 
        \resumeItem{Developed a method for converting GPS coordinates to map coordinates, used to verify SLAM map accuracy.} 
        \resumeItem{Developed a Gazebo plugin for a four-wheel drive vehicle motion simulation to test SLAM and control algorithms.} 
        \resumeItem{Contributed to developing a tool for launching autonomous systems with test options.} 
        \resumeItem{Assisted the team be the \textbf{overall winner} at 2023 FSG Driverless Cup and securing 7th place at FS East.} 
      \resumeItemListEnd
  %   \resumeSubheading
