...
% 新命令，用于需要额外行的条目
\newcommand{\resumeSubheadingExtended}[5]{  % 使用五个参数
  \vspace{-2pt}\item
    \begin{tabular*}{0.97\textwidth}{@{\extracolsep{\fill}}p{0.8\textwidth}r}
      \textbf{#1} & #2 \\ % 第一行：名称和地点
      \multicolumn{2}{l}{\textit{\small#3}} \\ % 第二行：专业名称
      \textit{\small#4} & \textit{\small#5} % 第三行：GPA, 排名信息及日期
